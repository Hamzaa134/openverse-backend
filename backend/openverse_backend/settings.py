"""
Django settings for openverse_backend project.
...
ROOT_URLCONF = 'openverse_backend.urls'
...
WSGI_APPLICATION = 'openverse_backend.wsgi.application'
...
AUTHENTICATION_BACKENDS = (
    ...
    'social_core.backends.github.GithubOAuth2',  # GitHub login
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Defines the folder where static files will be collected
